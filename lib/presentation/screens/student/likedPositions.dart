...
class LikedPositions extends StatefulWidget {
  const LikedPositions({super.key, required this.likedPositions});
  final List<Position> likedPositions;

  @override
  State<LikedPositions> createState() => _LikedPositionsState();
}

class _LikedPositionsState extends State<LikedPositions> {
  void removeFavourite(Position position) async {
    ...
    await SG.firestore.removeLikedPosition(
      position,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: Ws.appBar(Ss.liked, context, HomepageStudent()),
        body: Padding(
